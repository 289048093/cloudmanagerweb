...
<html>
	<head>
		<meta name="code" content="003006">
		<title>发送的订单</title>
		<script language="JavaScript" type="text/javascript"
			src="js/My97DatePicker/WdatePicker.js"></script>
		<script type="text/javascript" src="workorder/sendWorkOrder.js"></script>
		<script type="text/javascript" src="workorder/sendWorkOrderRes.js"></script>
		<script language="JavaScript" type="text/javascript"
			src="js/My97DatePicker/WdatePicker.js"></script>
	...
	<body>
		<s:form
			action="sendWorkorderManager/sendWorkorder!querySendWorkOrder.action"
			...
			<div class="ck_content_wrapper">
				...
				<div class="ck_content_header">
					...
					<div class="ck_content_header_btn_wrapper">
						<div class="ck_content_header_btn_wrapper">
							<div class="ck_content_header_btn" id="ckNewWorkOrder">
								新建工单
							</div>
							<div class="ck_dropDown">
							</div>
						</div>
					</div>
				...
				<div class="ck_content_body">
						...
						<div class="ck_search_inner_wrapper">
							<table id="search_table">
								<tr>
									...
									<td>
										<select name="cloudContext.params.qReceiveDomain" id="qReceiveDomain">
											<option value="">
												--请选择--
											</option>
											<s:iterator value="#request.cloudContext.params.receiveDomains"
												var="item">
												<option value="${item.id }"
													${item.id==cloudContext.params.qReceiveDomain[0]?
													"selected='selected'":"" }>
													${item.name }
												</option>
											</s:iterator>
					...
					<div id="ck_table_wrapper">
						<div class="ck_table">
										...
										<s:if test="#request.cloudContext.params.workOrders.size()>0">
											<s:iterator value="#request.cloudContext.params.workOrders"
												...
												<tr
													...
													<td
														title="<s:property value="#request.item.receiveDomainName" />">
														<s:property value="#request.item.receiveDomainName" />
													</td>
														...
														<div class="ck_table_operation">
															<s:if
																...
																<a
																	...
																	chkRightsUrl="sendWorkorderManager/sendWorkorder!closeWorkOrder.action"></a>
															</s:if>
															<s:if test="#request.item.attachmentCount>0">
																<a
																	...
																	chkRightsUrl="sendWorkorderManager/sendWorkorder!viewAttachment.action"></a>
															</s:if>
															<a
																href="sendWorkorderManager/sendWorkorder!view.action?workOrderId=${item.id }"
																target="_blank" class="ck_view" title="浏览"
																chkRightsUrl="sendWorkorderManager/sendWorkorder!view.action"></a>
							...
							<pg:pager
								url="sendWorkorderManager/sendWorkorder!querySendWorkOrder.action"
