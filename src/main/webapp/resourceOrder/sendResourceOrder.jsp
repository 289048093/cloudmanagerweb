...
<html>
	<head>
		...
		<script type="text/javascript"
			src="resourceOrder/sendResourceOrder.js"></script>
		<script type="text/javascript" src="resourceOrder/send_validate.js"></script>
		<s:set var="refuse"
			value="@com.cloudking.cloudmanagerweb.util.Constant@RESOURCEORDER_ACCEPING"></s:set>
		<script type="text/javascript">
			var accepting = ${refuse };
			$(function(){
		...
		<div class="ck_content_wrapper">
			...
			<div class="ck_content_header">
				...
				<div class="ck_content_header_btn_wrapper">
					<div class="ck_content_header_btn" id="ckNewSendResourceOrder">
						新建申请资源工单
					</div>
				</div>
			...
			<div class="ck_content_body">
				<s:form
					action="sendResourceOrderManager/sendResourceOrder!query.action"
					...
					<div id="ck_table_wrapper">
						<div class="ck_table">
														...
														<div class="ck_table_operation">
															<s:if
																...
																<a href="javascript:initUpdate(${item.id })"
																	...
																	chkRightsUrl="sendResourceOrderManager/sendResourceOrder!update.action,"></a>
																<a href="javascript:initDelete(${item.id })"
																	class="ck_del" title="删除"
																	chkRightsUrl="sendResourceOrderManager/sendResourceOrder!delete.action"></a>
															</s:if>
															<a
																href="sendResourceOrderManager/sendResourceOrder!view.action?cloudContext.vo.id=${item.id }"
																target="_blank" class="ck_view" title="浏览"
																chkRightsUrl="sendResourceOrderManager/sendResourceOrder!view.action"></a>
														</div>
													</td>
												</tr>
											</s:iterator>
							...
							<pg:pager url="resourceOrder/resourceOrder!query.action"
