var editStorageResourceWinTitle = '编辑存储资源'
var confirmDeleteWinTitle = '删除存储资源';
var newStorageResourceWinTitle = '新建存储资源';
var addOrUpdateHtml = 'storageResource/addOrUpdateWindow_.jsp';
// 当前操作的storageResourceID
var baseURL = "storageResourceManager/storageResource"
var currentId = 0;
var zTree = null;
var rootNode = null;
$(function() {
			 ...
			 * 点击新建资源按钮，弹出窗口
			 */
			$('#ckNewStorageResource').live('click', function() {
						ck_pop_win({
									width : 400,
									title : newStorageResourceWinTitle,
									url : addOrUpdateHtml
...
function initUpdate(id) {
	...
	ck_pop_win({
				width : 400,
				title : editStorageResourceWinTitle,
				url : addOrUpdateHtml
			}, initAddOrUpdateWindow);
}
...
function isAdd() {
	var title = $('.ck_pop_win_title').html();
	return title == newStorageResourceWinTitle;
}
/**
 * 是否修改
 */
function isUpdate() {
	var title = $('.ck_pop_win_title').html();
	return title == editStorageResourceWinTitle;
}
/**
 * 是否删除
 */
