...
<html>
	<head>
		<meta name="code" content="001004">
		<title>存储管理</title>
		<script type="text/javascript"
			src="storageResource/storageResource.js"></script>
		...
		<script type="text/javascript" src="storageResource/validate.js"></script>
	</head>
	<body>
		<s:form action="storageResourceManager/storageResource!query.action"
			...
			<div class="ck_content_wrapper">
				...
				<div class="ck_content_header">
					...
					<div class="ck_content_header_btn_wrapper">
						<div class="ck_content_header_btn" id="ckNewStorageResource"
							chkRightsUrl="storageResourceManager/storageResource!add.action">
							新建存储资源
						</div>
					</div>
						...
						<div class="ck_table">
							...
							<div class="ck_table_body_wrapper">
								<table cellpadding="0" cellspacing="0" class="ck_table_style"
									...
									<tbody>
										<s:if
											test="#request.cloudContext.params.storageResources.size()>0">
											<s:iterator
												value="#request.cloudContext.params.storageResources"
												var="item" status="st">
												<tr
													...
													<td class="ck_table_operation_td">
														<div class="ck_table_operation">
															<a href="javascript:initUpdate(${item.id })"
																chkRightsUrl="storageResourceManager/storageResource!update.action"
																class="ck_modify" title="编辑"></a>
															<a href="javascript:initDelete(${item.id })"
																chkRightsUrl="storageResourceManager/storageResource!delete.action"
																class="ck_del" title="删除"></a>
															<a href="rrd/storage_.jsp?id=${item.id }" class="ck_monitor"
							...
							<pg:pager
								url="storageResourceManager/storageResource!query.action"
